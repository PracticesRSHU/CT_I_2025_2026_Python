...
print(info_methods)
# with вираз as зміна
with open('methods_os.txt','at') as fileos:
    fileos.write(info_methods)

print(os.getcwd()) # E:\Tetiana\CT_I_Python_2025_2026_PYTHON
print(os.path.realpath('.')) #  E:\Tetiana\CT_I_Python_2025_2026_PYTHON
# # list catalog
print(os.listdir())
...
print(os.path.abspath('.')) #  E:\Tetiana\RSHU\CT_I_2025_2026_Python\11_files
...
try:
    ...
    os.rename('test_dir1','new_test_dir')
